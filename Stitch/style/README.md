...
The process begins innocently enough by inluding a style sheet.  Its a simple link.  Next we make slight modifications to some of the div and table classes. Then we simply get the input table and replace it with __fieldset__ tags around our inputs.   
