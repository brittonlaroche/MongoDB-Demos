...
### A. Importing the Application from git hub
...
5. log into your atlas cluster with your API key with the stich command line tool.


### B. Manually Creating the Application
