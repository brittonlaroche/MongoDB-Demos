...
Once you learn the basics of the docuemnt model and how the objects work together you will quickly relize you can build anything.  This shipping application is eerily similar to the [HR Application](../../Stitch/rest/README.md) in many respects, as many of the same concepts and objects were used to create the HR application.
