...
You have been tasked creating a minimum viable product (MVP), a basic protype of the airline shipping application. They wish to test both the functionality and performance of an application renting cargo space and providing shipment updates in real time to their third party shippers.
